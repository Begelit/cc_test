...
SECRET_KEY = 'django-insecure-f_2=xkrg5_-i7b4d__#da8y(j_()+_0&_32%m15xfuo$5kpr0a'
...
STATIC_URL = 'webpack/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'djapp','webpack'),
    #('node_modules', os.path.join(BASE_DIR,'dj_app','node_modules/')),
]
STATIC_ROOT = os.path.join(BASE_DIR, 'webpack')
